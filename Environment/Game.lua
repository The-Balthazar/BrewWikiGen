...
Footprints = {
    ...
    Amphibious1x1     = { SizeX = 1,  SizeZ = 1,  Caps = LayerCaps[ 3 --[[0x01 | 0x02]] ], MaxWaterDepth = 25,                   MaxSlope = 0.75, Flags = 0 },
    Amphibious3x3     = { SizeX = 3,  SizeZ = 3,  Caps = LayerCaps[ 3 --[[0x01 | 0x02]] ], MaxWaterDepth = 25,                   MaxSlope = 0.75, Flags = 0x01 },
    Amphibious6x6     = { SizeX = 6,  SizeZ = 6,  Caps = LayerCaps[ 3 --[[0x01 | 0x02]] ], MaxWaterDepth = 25,                   MaxSlope = 0.75, Flags = 0x01 },
    WaterLand1x1      = { SizeX = 1,  SizeZ = 1,  Caps = LayerCaps[ 9 --[[0x01 | 0x08]] ], MaxWaterDepth = 1, MinWaterDepth=0.1, MaxSlope = 0.75, Flags = 0 },
    WaterLand2x2      = { SizeX = 2,  SizeZ = 2,  Caps = LayerCaps[ 9 --[[0x01 | 0x08]] ], MaxWaterDepth = 1, MinWaterDepth=0.1, MaxSlope = 0.75, Flags = 0 },
    WaterLand3x3      = { SizeX = 3,  SizeZ = 3,  Caps = LayerCaps[ 9 --[[0x01 | 0x08]] ], MaxWaterDepth = 5, MinWaterDepth=0,   MaxSlope = 0.75, Flags = 0 },
    WaterLand5x5      = { SizeX = 5,  SizeZ = 5,  Caps = LayerCaps[ 9 --[[0x01 | 0x08]] ], MaxWaterDepth = 5, MinWaterDepth=0,   MaxSlope = 0.75, Flags = 0 },
    SurfacingSub2x2   = { SizeX = 2,  SizeZ = 2,  Caps = LayerCaps[ 12 --[[0x04 | 0x08]] ],                   MinWaterDepth=1.5,                  Flags = 0 },
    SurfacingSub3x3   = { SizeX = 3,  SizeZ = 3,  Caps = LayerCaps[ 12 --[[0x04 | 0x08]] ],                   MinWaterDepth=1.5,                  Flags = 0 },
    SurfacingSub4x4   = { SizeX = 4,  SizeZ = 4,  Caps = LayerCaps[ 12 --[[0x04 | 0x08]] ],                   MinWaterDepth=1.5,                  Flags = 0 },
    SurfacingSub12x12 = { SizeX = 12, SizeZ = 12, Caps = LayerCaps[ 12 --[[0x04 | 0x08]] ],                   MinWaterDepth=1.5,                  Flags = 0 },
